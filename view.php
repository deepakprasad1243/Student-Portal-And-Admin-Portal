...
else 
{
	...
	echo (' <div class="form-group" style="padding-left:10%;padding-right:10%;"> 
    ...
    <div class="col-sm-6" Style="padding-top:10px;">
      <button type="submit"  class="btn btn-primary btn-group-justified">View semester registration form </button>
    </div>
	<div class="col-sm-6" Style="padding-top:10px;">
      <a href="print_id.php"><button type="button" name="editd" class="btn btn-primary btn-group-justified">View Identity card form</button></a>
    </div>
  </div>
