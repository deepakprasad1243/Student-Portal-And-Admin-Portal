  ...
  .affix + .container-fluid{
	...
	<nav class="navbar navbar-default "  data-spy="affix" data-offset-top="197">
		 ...
		 $user=$_SESSION['username'];
		  ...
		  <?php
		  if(isset($_POST['dateQuery'])||isset($_POST['upload']))
			  echo '<button type="button" onclick="window.print();return false;" class="btn btn-success">&#128439&nbspPrint</button>';
...
{	$count = 1;
  ...
  <div  style="height:200px;width:170px;margin-top:25px;margin-left:42%;border-color:black;  border-style: solid; border-width: medium; " >
						...
						<p><img style="height:200px;width:170px;" src="images/'.$photo.'"> </p>
	</div>
  <br>
  <table class="table table-bordered" style="border-width:2px;border-color:black;table-layout: fixed;" >
  <tbody>
  <tr>
        <td style="border-width:2px;border-color:black;"colspan=3><label>Name of the student:&nbsp&nbsp&nbsp&nbsp</label>'.$name.'</td>
		<td style="border-width:2px;border-color:black;" colspan=2><label>Roll No.:&nbsp&nbsp&nbsp&nbsp</label>'.$roll.'</td> 
		<td style="border-width:2px;border-color:black;" colspan=3><label>Income Category:&nbsp&nbsp&nbsp&nbsp</label></td>
  </tr>
  <tr>
  ...
  <td style="border-width:2px;border-color:black;padding:0;"colspan=1><label>1. Institute fee (tuition fee + Hostel fee)</label></td>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=1><label>'.$amount.'</label></td>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=1><label>'.$tn.'</label></td>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=1><label></label>'.$td.'</td>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=2><label><img style="height:200px;width:100%;" src="images/'.$imageInstitute.'"></label></td>
  </tr>
  
  
  <tr>
  <td style="border-width:2px;border-color:black;padding:0;"colspan=1><label>2. Mess fee</label></td>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=1><label>'.$mamount.'</label></td>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=1><label>'.$mtn.'</label></td>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=1><label></label>'.$mtd.'</td>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=2><label><img style="height:200px;width:100%;" src="images/'.$imageMess.'"></label></td>
  </tr>
  ...
  <tbody>
  <tr>
  <td  colspan=2><label>SGPA of last two semisters: </label></td>
  <td  colspan=1><label>SGPA 1:&nbsp&nbsp&nbsp&nbsp</label>'.$s1.'</td>
  <td  colspan=1><label>SGPA 2:&nbsp&nbsp&nbsp&nbsp</label>'.$s2.'</td> 
  <td style="border-width:2px;border-color:black;"colspan=2><label>Backlogs:&nbsp&nbsp&nbsp&nbsp</label></td>
  </tr>
  <tr>
...
echo ('<thead>
      <tr>
		...
		<th>INSTITUTE FEE AMOUNT</th>
		<th>INSTITUTE FEE TRANSANCTION NO.</th>
		<th>INSTITUTE FEE TRANSANCTION DATE</th>
		
		<th>MESS FEE AMOUNT</th>
		<th>MESS FEE TRANSANCTION NO.</th>
		<th>MESS FEE TRANSANCTION DATE</th>
  ...
  
 {
    ...
    <div class="col-sm-offset-2 col-sm-8" style="padding-left:11%;padding-right:11%">
      <button type="submit" name="batchQuery" class="btn btn-primary btn-group-justified">Get Registrations</button>
		  ...
		  if(isset($_POST['uploads'])||isset($_POST['upload']))
		  {
			   echo (' <div class="row" style="padding-left:16%;">
		  <div class="col-md-4"><label for="sgpa" style="float:right;">Enter Student Roll No.: </label></div>
	      <div class="col-md-4"><input type="text" name="date" class="form-control" id="fees" placeholder="Roll No." required></div>
		  ...
		  echo'<br> <div class="form-group "> 
    <div class="col-sm-offset-2 col-sm-8" style="padding-left:11%;padding-right:11%">
      <button type="submit" name="upload" class="btn btn-primary btn-group-justified">Get uploads</button>
    </div>
  </div>';
...
{	
  ...
  <table class="table table-bordered" style="border-width:2px;border-color:black;table-layout: fixed;" >
  <thead>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=4><label>FEE DETAILS</label></td>	 
  </thead>
  <thead>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=1><label>FEE TYPE</label></td>
   <td style="border-width:2px;border-color:black;padding:0;text-align:center;"colspan=1><label>AMOUNT (Rs.)</label></td>
  ...
  <hr  style="border-width: medium;border-color:#3C7570;"><br>
				
<!--table class="table table-bordered" style="border-width:4px;border-color:black;table-layout: fixed;" >
  <thead>
   <td style="border-width:4px;border-color:black;color:green;padding:0;text-align:center;"colspan=6><label><h3><b><u>UPLOADED PHOTO</u></b></h3></label></td>	 
  </thead>
  <tbody>
  <tr>
  ...
  echo ('<p><img style="height:80%;width:100%;" src="images/'.$photo.'"> </p>');
  else
	  echo ('<span style="color:red;text-align:center;"><b><i>&#10008;&nbsp&nbspPhoto not uploaded by '.$roll.'. </i></b></span>');
  echo ('
  </td>
  </tr>
  </tbody>
  ...
  <br><hr  style="border-width: medium;border-color:#3C7570;"><br-->
				
<table class="table table-bordered" style="border-width:4px;border-color:black;table-layout: fixed;" >
  <thead>
   <td style="border-width:4px;border-color:black;color:green;padding:0;text-align:center;"colspan=6><label><h3><b><u>INSTITUTE FEE RECIEPT</u></b></h3></label></td>	 
  </thead>
  <tbody>
  <tr>
  <td colspan=6 rowspan=6>
  ...
  echo ('<p><img style="height:80%;width:100%;" src="images/'.$imageInstitute.'"> </p>');
  else
	  echo ('<span style="color:red;text-align:center;"><b><i>&#10008;&nbsp&nbspInstitute fee reciept not uploaded by '.$roll.'. </i></b></span>');
  echo ('
  </td>
  </tr>
  </tbody>
  ...
  <table class="table table-bordered" style="border-width:4px;border-color:black;table-layout: fixed;" >
  <thead>
   <td style="border-width:4px;border-color:black;color:green;padding:0;text-align:center;"colspan=6><label><h3><b><u>MESS FEE RECIEPT</u></b></h3></label></td>	 
  </thead>
  <tbody>
  <tr>
  <td colspan=6 rowspan=6>
  ...
  echo ('<p><img style="height:80%;width:100%;" src="images/'.$imageMess.'"> </p>');
  else
	  echo ('<span style="color:red;text-align:center;"><b><i>&#10008;&nbsp&nbspMess fee reciept not uploaded by '.$roll.'. </i></b></span>');
  echo ('
...
echo '<div id="annon_head" >
  ...
  <div class="form-group "> 
    <div class="col-sm-offset-2 col-sm-8" style="padding-left:11%;padding-right:11%">
      <button type="submit" name="uploads" class="btn btn-primary btn-group-justified">get uploads of student </button>
    </div>
  </div>
	  ');  
	  }
