...
{	$count = 1;
  ...
  <div class="row">
  <div class=" col-md-6" style="padding-bottom:10px;">
    <div class="col-md-3"><label for="email"  >Gender:</label></div>
    <div class="col-md-9">'.$gender.'</div>
  </div>
  <div class="form-group col-md-6" style="padding-bottom:10px;">
    <div class="col-md-3"><label for="category"  >D.O.B:</label></div>
    <div class="col-md-9">'.$dob.'
	</div>
  </div>
  </div>
  ...
  <div class="row">
  <div class=" col-md-6" style="padding-bottom:10px;">
    <div class="col-md-3"><label for="email"  >Blood Group:</label></div>
    <div class="col-md-9">'.$blood.'</div>
  </div>
  <div class="form-group col-md-6" style="padding-bottom:10px;">
    <div class="col-md-3"><label for="category"  >Religion:</label></div>
    <div class="col-md-9">'.$religion.'
	</div>
  </div>
  </div>
  ...
  <div class="row">
  <div class=" col-md-6" style="padding-bottom:10px;">
    <div class="col-md-3"><label for="email"  >Quota:</label></div>
    <div class="col-md-9">'.$quota.'</div>
  </div>
  <div class="form-group col-md-6" style="padding-bottom:10px;">
    <div class="col-md-3"><label for="category"  >Seat Alloted Category:</label></div>
    <div class="col-md-9">'.$seat.'
	</div>
  </div>
  </div>
...
<div class="row">
  ...
  <div class=" col-md-12" style="padding-bottom:10px;">
    <div class="col-md-3"><label for="fnumber"  >Residential&nbspAddress:</label></div>
    <div class="col-md-9">'.$s1.'</div>
  </div>
  ...
  <div class="row">
  <div class=" col-md-12" style="padding-bottom:10px;">
    <div class="col-md-3"><label for="fnumber"  >Corresponding&nbspAddress:</label></div>
    <div class="col-md-9">'.$cs1.'</div>
  </div>
